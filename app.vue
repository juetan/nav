      ...
      <div class="mx-auto max-w-[1180px] h-full flex justify-between items-center gap-4 px-6">
        ...
        <div class="gap-2 hidden md:flex">
          <a-dropdown trigger="hover">
            <button class="cursor-pointer bg-transparent dark:text-white hover:bg-gray-200 dark:hover-bg-[rgba(255,255,255,.2)] rounded py-1 px-2">
          ...
          <button @click="onGotoGithub" class="cursor-pointer bg-transparent dark:text-white hover:bg-gray-200 dark:hover-bg-[rgba(255,255,255,.2)] rounded py-1 px-2">
